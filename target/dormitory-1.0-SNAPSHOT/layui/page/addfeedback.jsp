...
<div class="layui-form layuimini-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="text" name="applicant" lay-verify="required" placeholder="请输入姓名" value="" class="layui-input"
                   autocomplete="off">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="phone" lay-verify="required|phone|number" placeholder="请输入联系方式" value=""
                   class="layui-input" autocomplete="off">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="content" class="layui-textarea" placeholder="请输入反馈信息" autocomplete="off"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            var index = layer.alert(JSON.stringify(data).replaceAll("\"", " "), {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        console.log(res)
                        if (res === "已发送反馈请求") {
                            layer.msg("已发送反馈请求", {time: 2000}, function () {
                                location.reload()
                            })
                        }
                    }
