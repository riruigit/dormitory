...
<%@ page import="com.lingnan.dormitory.pojo.Student" %>
                        ...
                        <div class="layui-card">
                            ...
                            <div class="layui-card-body">
                                ...
                                <div style="width:100%;min-height:300px;">
                                    ...
                                    <p style=" padding:5px 20px 5px 50px;">性别：<%
                                        if (s.getGender().equals(String.valueOf(0))) out.print("无");  else out.println(s.getGender());
                                    %><br/></p>
                                    <p style=" padding:5px 20px 5px 50px;">身份：${sessionScope.userInfo.identity} <br/>
                                    </p>
                                    <p style=" padding:5px 20px 5px 50px;">苑区：<%
                                        if (s.getCourtyard().equals(String.valueOf(0))) out.print("无"); else out.println(s.getCourtyard());
                                    %><br/>
                                    </p>
                                    <p style=" padding:5px 20px 5px 50px;">宿舍号：<%
                                        if (s.getDormitoryid().equals(String.valueOf(0))) out.print("无"); else out.println(s.getDormitoryid());
                                    %><br/>
                                    </p>
                                    <p style=" padding:5px 20px 5px 50px;">院系：<%
                                        if (s.getDepartment().equals(String.valueOf(0))) out.print("无"); else out.println(s.getDepartment());
                                    %><br/>
                                    </p>
                                    <p style=" padding:5px 20px 5px 50px;">班别：<%
                                        if (s.getClassroom().equals(String.valueOf(0))) out.print("无"); else out.println(s.getClassroom());
                                    %><br/>
                                    </p>
                                    <p style=" padding:5px 20px 5px 50px;">联系方式：<%
                                        if (s.getPhone().equals(String.valueOf(0))) out.print("无"); else out.println(s.getPhone());
                                    %><br/>
                                    </p>
                                </div>
                            </div>
