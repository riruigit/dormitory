        ...
        <form class="layui-form login-bottom">
            <div class="center">
                <div class="item">
                    ...
                    <input type="text" name="id" autocomplete="off" lay-verify="required" placeholder="请输入登录学号"
                           maxlength="24"/>
                </div>

                <div class="item">
                    <span class="icon icon-3"></span>
                    <input type="password" name="password" autocomplete="off" lay-verify="required" placeholder="请输入密码"
                           maxlength="20">
